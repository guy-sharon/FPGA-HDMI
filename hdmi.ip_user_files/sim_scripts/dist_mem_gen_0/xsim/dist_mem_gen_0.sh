...
#
# Generated by Vivado on Fri Sep 24 14:03:16 +0300 2021
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot dist_mem_gen_0 xil_defaultlib.dist_mem_gen_0 xil_defaultlib.glbl -log elaborate.log
}
...
{
  file="xsim.ini"
  lib_map_path="D:/FPGA/Xilinx/2021.1/Vivado/2021.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
