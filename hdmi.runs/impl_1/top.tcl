...
namespace eval ::optrace {
  variable script "D:/Xilinx/Vivado/2022.1/projects/hdmi/hdmi.runs/impl_1/top.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet D:/Xilinx/Vivado/2022.1/projects/hdmi/hdmi.runs/synth_1/top.dcp
...
OPTRACE "Write Bitstream: post hook" START { }
  set src_rc [catch { 
    puts "source D:/Xilinx/Vivado/2022.1/projects/hdmi/bit.tcl.txt"
  ...
  if {$src_rc} { 
    ...
    if { $tool_flow eq {SDx} } { 
      ...
      send_gid_msg -id 3 -ssname VPL_TCL -severity ERROR "sourcing script D:/Xilinx/Vivado/2022.1/projects/hdmi/bit.tcl.txt failed"
    } else {
      send_msg_id runtcl-1 status "$_RESULT"
      send_msg_id runtcl-2 status "sourcing script D:/Xilinx/Vivado/2022.1/projects/hdmi/bit.tcl.txt failed"
    }
    return -code error
  }
